...
package com.quartz.examples.example9;
...
public class Job1Listener implements JobListener {
  ...
  public void jobToBeExecuted(JobExecutionContext inContext) {
    _log.info("xxxxxxxxxxxxxxxx**Job1Listener says: Job Is about to be executed.");
  }

  public void jobExecutionVetoed(JobExecutionContext inContext) {
    _log.info("xxxxxxxxxxxxxxxx**Job1Listener says: Job Execution was vetoed.");
  }

  public void jobWasExecuted(JobExecutionContext inContext, JobExecutionException inException) {
    _log.info("xxxxxxxxxxxxxxxx**Job1Listener says: Job was executed.");
