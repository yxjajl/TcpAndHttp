...
package com.quartz.examples.example4;
...
public class JobStateExample {
	...
	public void run() throws Exception {
		...
		Date startTime = nextGivenSecondDate(null, 30);
		...
		log.info(job1.getKey() + " will run at: " + scheduleTime1 + " and repeat: " + trigger1.getRepeatCount() + " times, every "
		...
		log.info(job2.getKey().toString() + " will run at: " + scheduleTime2 + " and repeat: " + trigger2.getRepeatCount() + " times, every "
