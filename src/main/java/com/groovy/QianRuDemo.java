...
public class QianRuDemo {
	...
	private GroovyObject instanceGroovyObject;
	...
	public void load() {
		...
		try {
			...
			instanceGroovyObject = (GroovyObject) testGroovyClass.newInstance();
		} catch (Exception e) {
	...
	public void tt() {
		...
		instanceGroovyObject.invokeMethod("change", vo);
		System.out.println(CommonUtil.getClassString(vo));

		vo = (QianRuVO) instanceGroovyObject.invokeMethod("init", null);
		System.out.println(CommonUtil.getClassString(vo));
	}
